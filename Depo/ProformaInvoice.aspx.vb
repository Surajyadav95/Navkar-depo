...
Partial Class Summary_BCYMovement
    ...
    Dim blnIsTariff As Boolean = False
    ...
    Protected Sub Filldropdown()
        Try
            ...
            ddlEXTCriteria.DataValueField = "ID"
                        ...
                        If dt5.Rows.Count > 0 Then
                            For j As Integer = 0 To dt5.Rows.Count - 1
                                ...
                                If dt6.Rows.Count > 0 Then
                                    ...
                                    If Val(dblNetAmount_IND) >= 0 And blnIsTariff = True Then
    ...
    Protected Sub btnsave_Click(sender As Object, e As EventArgs) Handles btnsave.Click
        Try
            ...
            strSql = "USP_INSERT_INTO_PROFORMA_M_WEB '" & Trim(strWorkyear) & "','" & Convert.ToDateTime(txtInvoiceDate.Text).ToString("yyyy-MM-dd HH:mm") & "',"
            ...
            strSql += ",'" & Trim(txtVessels.Text) & "','" & Trim(txtPONo.Text & "") & "','" & Trim(txtViaNo.Text & "") & "','" & Convert.ToDateTime(txtBilledToDate.Text).ToString("yyyy-MM-dd HH:mm") & "','" & Trim(txtVesselID.Text) & "','" & Replace(Trim(txtRemarks.Text), "'", "''") & "','" & Trim(ddlEXTCriteria.SelectedItem.Text) & "'"
            strSql += ",'" & Val(ddlTaxID.SelectedValue) & "'"
            dt = db.sub_GetDatatable(strSql)
                ...
                If chkright.Checked = True Then
                    ...
                    If dt2.Rows.Count > 0 Then
                        For i = 0 To dt2.Rows.Count - 1
                            strSql = ""
                            strSql += "USP_INSERT_INTO_PROFORMA_D_WEB " & Val(intid) & ",'" & strinvoiceNo & "','" & strWorkyear & "',"
