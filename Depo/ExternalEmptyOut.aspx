<%@ Page Title="Depo | External Empty Out" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="ExternalEmptyOut.aspx.vb" Inherits="Summary_BCYMovement" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 
       
<head>
<title>Depo | External Empty Out</title>
...
<i class="glyphicon glyphicon-transfer"></i> External Empty Out
</h3>
...
<asp:TextBox ID="txtGatePassDate" runat="server" TextMode="DateTimeLocal" Class="form-control text-label"></asp:TextBox>
...
<a href="ExternalEmptyOut.aspx" class="btn btn-info btn-block">OK</a>
...
<a href="ExternalEmptyOut.aspx" class="btn btn-danger ">No</a>
</div>
</div>
</ContentTemplate>
</asp:UpdatePanel>
