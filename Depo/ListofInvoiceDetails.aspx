<%@ Page Title="Assessment Summary" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
...
<asp:DropDownList ID="ddlShipping"  runat="server"   class="form-control text-label">
    ...
    <div class="col-md-3 col-xs-12" style="display:none;"  id="divinvoice" runat="server">
<div class="form-group text-label">
 <b>Invoice Type</b>
...
>Print</a>
    ...
    <asp:LinkButton ID="lnkAnnexure" ControlStyle-CssClass='btn btn-info btn-xs outline' Text="Annexure" OnClick="lnkAnnexure_Click"
...
<ItemStyle HorizontalAlign="Left" Width="200px" />
    ...
    <asp:BoundField  DataField="Invoice Date" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Center" HeaderText="Invoice Date"></asp:BoundField>
<asp:TemplateField HeaderText="Invoice No" HeaderStyle-CssClass="text-center">
<ItemTemplate>

<asp:Label runat="server" ID="lblassessNo" Text='<%#Eval("InvoiceNo")%>'></asp:Label>
...
<asp:BoundField DataField="SLName" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Center"  HeaderText="Line Name"  ></asp:BoundField>
    <asp:BoundField DataField="Remarks" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Center"  HeaderText="Remarks"  ></asp:BoundField>
    <asp:BoundField DataField="Total" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Center"  HeaderText="Total"  ></asp:BoundField>
    <asp:BoundField DataField="GST" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Center"  HeaderText="GST"  ></asp:BoundField>
