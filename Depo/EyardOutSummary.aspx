<%@ Page Title="Depo |Out Empty Yard Summary" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="EyardOutSummary.aspx.vb" culture="en-GB" Inherits="Summary_BCYMovement" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <head>
<title>Depo |Out Empty Yard Summary</title>
</head>
    <style>
        .header-center{
            text-align:center
...
<h3>
<i class="glyphicon glyphicon-transfer"></i>Out Empty Yard Summary
</h3>
...
<Columns>
     <asp:TemplateField>
<ItemTemplate>
    <a  href='<%# "../Depo/Report_Epic/EyardOutPrint.aspx?GpNo=" & (DataBinder.Eval(Container.DataItem, "GP No")).ToString()%>'target="_blank" 
