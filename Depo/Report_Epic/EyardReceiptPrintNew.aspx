<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EyardReceiptPrintNew.aspx.vb" Inherits="Report_Bond_BondReceiptPrintNew" %>
...
<body>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="1000px" Height="600px" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
        <LocalReport ReportPath="Hazira\Report_Epic\EyardReceiptPrintDetails.rdlc" >
        </LocalReport>
        </rsweb:ReportViewer>
    </div>
    </form>
