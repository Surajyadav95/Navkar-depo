...
Partial Class Report_Bond_BondReceiptPrintNew
    ...
    Private Sub LoadReport()
        Try
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Depo/Report_Epic/EyardReceiptPrintDetails.rdlc")
            ...
            Dim datasource2 As New ReportDataSource("DateSet3", dsReceipt.Tables(0))
            ...
            'Dim p30 As New ReportParameter("LastAssessNo1", LastAssessNo1)
            Dim p30 As New ReportParameter("NetAmount", NetAmount)
            Dim p31 As New ReportParameter("TDS", TDS)
            Dim p32 As New ReportParameter("ReceiptAmount", ReceiptAmount)
            Dim p33 As New ReportParameter("Inwords", Inwords)
            Dim p34 As New ReportParameter("Remarks", Remarks)
            Dim p35 As New ReportParameter("Receipt", Receipt)
            Dim p36 As New ReportParameter("ReceiptDate", ReceiptDate)
