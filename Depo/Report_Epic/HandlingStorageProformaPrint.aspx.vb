    ...
    Private Sub LoadReport()
        Try
            ...
            If (Request.QueryString("InvoiceType")) = "3" Then
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Depo/Report_Epic/HandlingEmptyRepoProformaPrint.rdlc")
            Else
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Depo/Report_Epic/HandlingStorageProformaPrint.rdlc")
            End If

            Dim InvoiceNo As String = Request.QueryString("InvoiceNo")
            Dim WorkYear As String = Request.QueryString("WorkYear")

            ds = db.sub_GetDataSets("USP_HANDLING_STORAGE_PROFORMA_INVOICE_PRINT '" & InvoiceNo & "','" & WorkYear & "'")
            ...
            Dim p45 As New ReportParameter("Reference_Type", Reference_Type)
            Dim p46 As New ReportParameter("ReferenceNo", ReferenceNo)

            Me.ReportViewer1.LocalReport.SetParameters(New ReportParameter() {p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23, p24, p25, p26, p27, p28, p29, p30, p31, p32, p33, p34, p35, p36, p37, p38, p39, p40, p41, p42, p43, p44, p45, p46})
