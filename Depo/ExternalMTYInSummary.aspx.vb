...
Partial Class Summary_BCYMovement
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        Try
            ...
            End If
            strSql = ""
            strSql += " Get_Sp_ExternalInDetails '" & Convert.ToDateTime(Trim(txtfromDate.Text & "")).ToString("yyyy-MMM-dd HH:mm") & "','" & Convert.ToDateTime(Trim(txttoDate.Text & "")).ToString("yyyy-MMM-dd HH:mm") & "',"
            strSql += "'" & Trim(ddlcriteria.SelectedItem.Text & "") & "','" & Name & "'"
    ...
    Protected Sub btnExport_Click(sender As Object, e As EventArgs) Handles btnExport.Click
        Try
            ...
            strSql = ""
            strSql += " Get_Sp_ExternalInDetails '" & Convert.ToDateTime(Trim(txtfromDate.Text & "")).ToString("yyyy-MM-dd HH:mm") & "','" & Convert.ToDateTime(Trim(txttoDate.Text & "")).ToString("yyyy-MM-dd HH:mm") & "',"
            strSql += "'" & Trim(ddlcriteria.SelectedItem.Text & "") & "','" & Name & "'"
            dt = db.sub_GetDatatable(strSql)
            strSql = ""
            ...
            If (dt.Rows.Count > 0) Then
                Using wb As New XLWorkbook()
                    wb.Worksheets.Add(dt, "Gate IN Summary" & Convert.ToDateTime(Now).ToString("dd-MM-yyyy") & "")
                    ...
                    With wb.Worksheets(0)
                        ...
                        .Cell(8, 1).Value = "Gate In Details"
                        ...
                        For i = 0 To dt.Rows.Count - 1
                            intRow += 1
                            .Cell(intRow, 10).DataType = XLCellValues.DateTime
                        Next
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=GateInSummary" & Convert.ToDateTime(Now).ToString("ddMMyyyyHHmm") & ".xlsx")
