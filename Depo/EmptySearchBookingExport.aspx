<%@ Page Title="" Language="VB" EnableEventValidation="false" MasterPageFile="~/Depo/PopUp.master" AutoEventWireup="false" CodeFile="EmptySearchBookingExport.aspx.vb" Inherits="Account_ItemList" Culture="en-GB" %>
...
<h1>Empty Boooking Search<small class="pull-right" style="margin-right:20px"></small></h1>
...
CommandArgument='<%# DataBinder.Eval(Container.DataItem, "GateAllowID")%>' runat="server"
