<%@ Page Title="Epic" Language="VB" EnableEventValidation="false" MasterPageFile="~/Depo/PopUp.master" AutoEventWireup="false" CodeFile="HoldReasonMaster.aspx.vb" Inherits="Account_ItemList" Culture="en-GB" %>
...
<h1>Hold Reason Master<small class="pull-right" style="margin-right:20px"></small></h1>
...
<div class="form-group text-label">
<b  >Hold Reason</b>
<asp:TextBox ID="txtHoldReason" Style="text-transform:uppercase"  class="form-control text-label"  placeholder="Hold Reason"
...
<div class="form-group" style="padding-top:10px">
<a href="HoldReasonMaster.aspx" id="btnclear" runat="server" class="btn btn-primary btn btn-sm outline ">
Clear
</a> 
</div>
...
<a href="HoldReasonMaster.aspx" class="btn btn-info btn-block">OK</a>
...
function ValidationSave() {
    ...
    var txtHoldReason = document.getElementById('<%= txtHoldReason.ClientID%>').value;
...
if (txtHoldReason == "") {
document.getElementById('<%= txtHoldReason.ClientID%>').style.borderColor = "red";
