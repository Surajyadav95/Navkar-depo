...
Partial Class Account_ItemList
    ...
    Protected Sub btnsearch_Click(sender As Object, e As EventArgs)
        Try
            ...
            strSql = ""
            strSql = "select top 1 entryid, containerno, outdate,  approveddate from eyard_stock where ContainerNo ='" & Trim(txtContainerno.Text) & "' order by entryid desc"
            ...
            If dt.Rows.Count > 0 Then
                If dt.Rows(0)("Outdate") <> "" Then
                    ...
                    Exit Sub
                End If
                If Trim(dt.Rows(0)("approveddate") & "") <> "" Then
                    '   If dttemp.Rows(0)("approveddate") <> "" Then
                    ScriptManager.RegisterStartupScript(Me, Me.GetType, "Key", "alert('Container is approved. Cannot proceed');", True)
            ...
            strSql = ""
            strSql = "SP_ShowEstimate '" & Trim(txtContainerno.Text) & "','" & Trim(lblEntryID.Text) & "'"
            dt1 = db.sub_GetDatatable(strSql)
            If dt1.Rows.Count > 0 Then
                txtEstdate.Text = Trim(dt1.Rows(0)("Est_Date") & "")
                txtAmt.Text = Trim(dt1.Rows(0)("Est_Amount") & "")
    ...
    Protected Sub btncancelyes_ServerClick(sender As Object, e As EventArgs)
        strSql = ""
        strSql = ""
        strSql = "sp_Cancel_Etimate '" & Trim(txtContainerno.Text) & "','" & Trim(lblEntryID.Text) & "','" & Trim(lblEstimat_ID.Text) & "' "
