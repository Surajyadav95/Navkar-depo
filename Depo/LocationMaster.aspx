<%@ Page Title="Hazira" Language="VB" EnableEventValidation="false" MasterPageFile="PopUp.master" AutoEventWireup="false" CodeFile="LocationMaster.aspx.vb" Inherits="Account_ItemList" Culture="en-GB" %>
...
<h1>Location Master  <small class="pull-right" style="margin-right: 20px"></small></h1>
...
<b>Location ID</b>
<asp:TextBox ID="txtLocationID" Style="text-transform: uppercase" ReadOnly="true" class="form-control text-label" placeholder="NEW"
...
<div class="form-group text-label">
<b>Location Name</b>
<asp:TextBox ID="txtLocationName" Style="text-transform: uppercase" class="form-control text-label" placeholder="Location Name"
runat="server"></asp:TextBox>
</div>
</div>
    </div>
...
<a href="LocationMaster.aspx" class="btn btn-info btn-block">OK</a>
...
function ValidationSave() {
    ...
    var txtLocationName = document.getElementById('<%= txtLocationName.ClientID%>').value;
