<%@ Page Title="Depo |Master Inventory" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="MasterInventory.aspx.vb" Inherits="Summary_BCYMovement" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <head>
<title>Depo | Master Inventory</title>
</head>
    <style>
        .header-center{
            text-align:center
...
<h3>
<i class="glyphicon glyphicon-transfer"></i>Master Inventory
</h3>
...
AutoGenerateColumns="False" EmptyDataText="No records found!" ShowHeaderWhenEmpty="true" OnPageIndexChanging="grdsummary_PageIndexChanging"  AllowPaging="true" PageSize="10" >
