...
Partial Class Account_ItemList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            db.sub_ExecuteNonQuery("Delete from Temp_Empty_Booking_search Where UserID=" & Session("UserId_DepoCFS") & "")
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        Try
            ...
            strSql = ""
            strSql += "USP_insert_into_Temp_Empty_Booking_search '" & Auto_Id & "','" & Session("UserId_DepoCFS") & "'"
    ...
    Protected Sub btnsearch_Click(sender As Object, e As EventArgs)
        Try
            strSql = ""
            strSql += "USP_Eyard_list_Gst_parties '" & Trim(txtsearch.Text & "") & "'"
