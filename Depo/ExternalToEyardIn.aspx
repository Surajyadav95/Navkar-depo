<%@ Page Title="Depo | External  To Eyard In" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="ExternalToEyardIn.aspx.vb" Inherits="Summary_BCYMovement" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 
       
<head>
<title>Depo | External  To Eyard In</title>
...
<i class="glyphicon glyphicon-transfer"></i>External  To Eyard In
</h3>
...
<Columns>
    ...
    <asp:TemplateField HeaderText="Location" HeaderStyle-CssClass="center-header">
       ...
       <asp:Label ID="lblLocation" runat="server" text='<%#Eval("Location")%>'></asp:Label>
              <asp:Label ID="lblEntryID" Visible="false" runat="server" text='<%#Eval("EntryID")%>'></asp:Label>
       <asp:Label ID="lblLineID" runat="server" Visible="false" text='<%#Eval("LineID")%>'></asp:Label>
        </ItemTemplate>
        <ItemStyle HorizontalAlign="Center" /> 
        </asp:TemplateField>
