<%@ Page Title="Depo | Empty External Container Report" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="EmpHoldReport.aspx.vb" Inherits="Summary_BCYMovement" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <head>
<title>Depo |Empty External Container Report</title>
</head>
    <style>
        .header-center{
            text-align:center
...
<h3>
<i class="glyphicon glyphicon-transfer"></i>Hold Report
</h3>
...
AutoGenerateColumns="true" EmptyDataText="No records found!" ShowHeaderWhenEmpty="true" OnPageIndexChanging="grdHoldDets_PageIndexChanging"  AllowPaging="true" PageSize="10" >
...
<Columns>
    ...
    <div class="form-group text-label pull-left" >
