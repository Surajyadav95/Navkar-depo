...
Partial Class Summary_BCYMovement
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        Try
            ...
            strSql = ""
            strSql += " Get_Sp_notoffloadinginvoices '" & Convert.ToDateTime(Trim(txtfromDate.Text & "")).ToString("yyyy-MM-dd HH:mm") & "','" & Convert.ToDateTime(Trim(txttoDate.Text & "")).ToString("yyyy-MM-dd HH:mm") & "', '',''"
        ...
        Try
            ...
            If (dt.Rows.Count > 0) Then
                Using wb As New XLWorkbook()
                    wb.Worksheets.Add(dt, "List Of Container" & Convert.ToDateTime(Now).ToString("dd-MM-yyyy") & "")
                    ...
                    With wb.Worksheets(0)
                      ...
                      .Cell(1, 1).Value = Trim(dt10.Rows(0)("con_Name") & "")
                        ...
                        .Cell(11, 1).Value = "List Of Pending Invoice Details"
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=ListOfPendingInvoiceDetails" & Convert.ToDateTime(Now).ToString("ddMMyyyyHHmm") & ".xlsx")
