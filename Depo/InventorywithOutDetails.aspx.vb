...
Partial Class Summary_BCYMovement
    ...
    Private Sub fill_Container_Summary()
        ...
        strSql = ""
        strSql += " Get_Sp_EyardInventory_MasterInventory '" & Convert.ToDateTime(Trim(txtason.Text & "")).ToString("yyyyMMddHHmmss") & "','" & Trim(ddlcriteria.SelectedItem.Text & "") & "',"
        ...
        Try
            ...
            If (dt1.Rows.Count > 0) Then
                Using wb As New XLWorkbook()
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=InventoryWithOutDetails" & Convert.ToDateTime(Now).ToString("ddMMyyyyHHmm") & ".xlsx")
