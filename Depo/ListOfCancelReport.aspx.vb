...
Partial Class Summary_BCYMovement
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        Try
            ...
            strSql = ""
            strSql += " usp_Cancel_Report '" & Convert.ToDateTime(Trim(txtfromDate.Text & "")).ToString("yyyy-MM-dd HH:mm") & "','" & Convert.ToDateTime(Trim(txttoDate.Text & "")).ToString("yyyy-MM-dd HH:mm") & "'"
        ...
        Try
            ...
            If (dt.Rows.Count > 0) Then
                Using wb As New XLWorkbook()
                    wb.Worksheets.Add(dt, "Cancel Report" & Convert.ToDateTime(Now).ToString("dd-MM-yyyy") & "")
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=CancelReport" & Convert.ToDateTime(Now).ToString("ddMMyyyyHHmm") & ".xlsx")
