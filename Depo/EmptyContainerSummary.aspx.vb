...
Partial Class Summary_BCYMovement
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        Try
            ...
            strSql = ""
            strSql += " sp_GetEmptyInDetsNew_Depo '" & Convert.ToDateTime(Trim(txtfromDate.Text & "")).ToString("yyyy-MM-dd HH:mm") & "','" & Convert.ToDateTime(Trim(txttoDate.Text & "")).ToString("yyyy-MM-dd HH:mm") & "',"
            ...
            If (dt.Rows.Count > 0) Then
                Using wb As New XLWorkbook()
                    ...
                    With wb.Worksheets(0)
                        ...
                        .Cell(11, 1).Value = "Gate IN Summary"
