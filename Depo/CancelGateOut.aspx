<%@ Page Title="Depo | Cancel Gate Out" Language="VB" EnableEventValidation="false" MasterPageFile="~/Depo/PopUp.master" AutoEventWireup="false" CodeFile="CancelGateOut.aspx.vb" Inherits="Account_ItemList" Culture="en-GB" %>
...
<h1>Cancel Gate Out<small class="pull-left" style="margin-right:20px"></small></h1>
...
<div class="form-group text-label">
<b  >Out Date</b>
<asp:TextBox ID="txtOutdate" Style="text-transform:uppercase" ReadOnly="true" class="form-control text-label"  placeholder="Out Date"
runat="server"   ></asp:TextBox>
</div>
</div>
...
<div class="form-group" style="padding-top:18px">                          
<a href="CancelGateOut.aspx" id="btnclear" runat="server" class="btn btn-primary btn-sm outline ">
Clear
</a>                               
</div>                                                                               
</div>
...
<a href="CancelGateOut.aspx" class="btn btn-info btn-block">OK</a>
...
<a href="CancelGateOut.aspx" class="btn btn-danger ">No</a>
</div>
</div>
