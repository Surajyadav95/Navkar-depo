<%@ Page Title="Depo | Cancel Repair Containers" Language="VB" EnableEventValidation="false" MasterPageFile="~/Depo/PopUp.master" AutoEventWireup="false" CodeFile="CancelRepair.aspx.vb" Inherits="Account_ItemList" Culture="en-GB" %>
...
<h1>Cancel Repair Containers<small class="pull-left" style="margin-right:20px"></small></h1>
...
<div class="form-group text-label">
<b  >Repair Date</b>
<asp:TextBox ID="txtRepairdate" Style="text-transform:uppercase" ReadOnly="true" class="form-control text-label"  placeholder="Repair Date"
runat="server"   ></asp:TextBox>
</div>
</div>
...
<div class="form-group text-label">
<b  >Repair Amt</b>
<asp:TextBox ID="txtAmt" Style="text-transform:uppercase" ReadOnly="true" class="form-control text-label"  placeholder="Repair Amt"
runat="server"   ></asp:TextBox>
</div>
</div>  
...
<div class="form-group" style="padding-top:18px">                          
<a href="CancelEstimation.aspx" id="btnclear" runat="server" class="btn btn-primary btn-sm outline ">
Clear
</a>                               
</div>                                                                               
</div>
...
<a href="CancelEstimation.aspx" class="btn btn-info btn-block">OK</a>
...
<a href="CancelEstimation.aspx" class="btn btn-danger ">No</a>
</div>
</div>
