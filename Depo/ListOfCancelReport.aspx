<%@ Page Title="Depo |List Of Cancel Report" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="ListOfCancelReport.aspx.vb" Inherits="Summary_BCYMovement" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <head>
<title>Depo |List Of Cancel Report</title>
</head>
    <style>
        .header-center{
            text-align:center
...
<h3>
<i class="glyphicon glyphicon-transfer"></i>List Of Cancel Report
</h3>
