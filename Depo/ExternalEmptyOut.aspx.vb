...
Partial Class Summary_BCYMovement
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            db.sub_ExecuteNonQuery("delete from Temp_External_Out where USERID=" & Session("UserId_DepoCFS") & "")
    ...
    Protected Sub grid()
        Try
            dt7 = db.sub_GetDatatable("USP_Temp_External_Out '" & Session("UserId_DepoCFS") & "'")
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        Try
            ...
            strSql = ""
            strSql = "select OutDate,containerNo,EntryId FROM External_MTY_Out Where ContainerNo='" & Trim(txtContainer.Text) & "' AND EntryId = " & Val(lblEntryID.Text) & " and iscancel=0"
            dt = db.sub_GetDatatable(strSql)
            If dt.Rows.Count > 0 Then
            ...
            'Call Sub_SGTRate()
            strSql = ""
            strSql = "USP_INSERT_Temp_External_Out'" & Trim(txtContainer.Text & "") & "','" & Trim(TxtSize.Text & "") & "','" & Trim(txtType.Text & "") & "','" & Trim(lblisocode.Text & "") & "','" & Trim(lbllineid.Text & "") & "','" & Trim(txtBookingNo.Text & "") & "',"
    ...
    Protected Sub txtContainer_TextChanged(sender As Object, e As EventArgs) Handles txtContainer.TextChanged
        Try
            ...
            'dt.Clear()
            strSql = ""
            strSql = "exec sp_getExternalApprStatus '" & Trim(txtContainer.Text & "") & "'"
            dt = db.sub_GetDatatable(strSql)
            ...
            If Trim(txtContainer.Text) <> "" Then
                If Len(Trim(txtContainer.Text & "")) = 11 Then
                    ...
                    strSql = ""
                    strSql = "exec get_sp_container_fetch_for_Out_External '" & Trim(txtContainer.Text & "") & "'"
                    ...
                    If dt4.Rows.Count > 0 Then
                        ...
                        txtLineName.Text = Trim(dt4.Rows(0)("LineI") & "")
                        ...
                        'dt.Clear()
                        strSql = ""
                        strSql = "Select DATEDIFF(day,INDate,GetDate()) [Day] from External_MTY_In Where EntryID=" & Val(lblEntryID.Text) & " and ContainerNo='" & Trim(txtContainer.Text) & "'"
                        dt = db.sub_GetDatatable(strSql)
                        If dt.Rows.Count > 0 Then
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        Try
            ...
            strSql = "SELECT isnull(MAX(GpNo),0)+1 as EntryID FROM External_MTY_Out WITH (XLOCK)"
            ...
            For Each row As GridViewRow In grdHoldDetails.Rows
                strSql = ""
                strSql += "sp_SaveExternal_MTY_Out'" & intEntryID & "','" & Convert.ToDateTime(Trim(txtGatePassDate.Text & "")).ToString("yyyy-MM-dd HH:mm") & "','" & Trim(ddlMovementBy.SelectedItem.Text & "") & "','" & Trim(ddlMovementtype.SelectedItem.Text & "") & "',"
