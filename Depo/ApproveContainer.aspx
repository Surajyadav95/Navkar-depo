<%@ Page Title="Depo | Approve Container" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="ApproveContainer.aspx.vb" Inherits="Summary_BCYMovement" Culture="en-GB" %>
...
<i class="glyphicon glyphicon-transfer"></i> Approve Container
</h3>
...
<Columns>  
    ...
    <asp:TemplateField HeaderText="Descriptions" HeaderStyle-CssClass="text-center">
        <ItemTemplate>
            <asp:Label runat="server" ID="lblDescription" text='<%#Eval("Descriptions")%>'></asp:Label>
        </ItemTemplate>
    ...
    <asp:TemplateField HeaderText="Man Hours" HeaderStyle-CssClass="text-center">
        <ItemTemplate>
            <asp:Label runat="server" ID="lblManhours" text='<%#Eval("Man Hours")%>'></asp:Label>
        </ItemTemplate>
        <ItemStyle HorizontalAlign="Center" />
    </asp:TemplateField>
...
<div class="form-group text-label">
<b  >Aprrove Date</b>
<asp:TextBox ID="txtApproveDate" class="form-control text-label" TextMode="DateTimeLocal" runat="server"   ></asp:TextBox>
</div>
</div>
...
<a href="ApproveContainer.aspx" id="btnclear" runat="server" class="btn btn-primary btn-sm">
Clear
</a> 
...
<a href="ApproveContainer.aspx" class="btn btn-info btn-block">OK</a>
