<%@ Page Title="" Language="VB" EnableEventValidation="false" MasterPageFile="~/Depo/PopUp.master" AutoEventWireup="false" CodeFile="ProformaSearch.aspx.vb" Inherits="Account_ItemList" Culture="en-GB" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
<script type="text/javascript" >
function callparentfunction() {
 
    window.opener.document.getElementById("ContentPlaceHolder1_btnProforma").click();
...
<h1>Proforma Search  <small class="pull-right" style="margin-right:20px"></small></h1>
...
AutoGenerateColumns="True" EmptyDataText="No records found!" ShowHeaderWhenEmpty="true" OnPageIndexChanging="grdcontainer_PageIndexChanging"  AllowPaging="true" PageSize="6">
...
CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Proforma No")%>' runat="server"
