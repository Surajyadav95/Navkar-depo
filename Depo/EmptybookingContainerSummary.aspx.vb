...
Partial Class Summary_BCYMovement
    ...
    Protected Sub btnShow_Click(sender As Object, e As EventArgs)
        Try
            ...
            ElseIf ddlSearchOn.SelectedItem.Text = "Booking No" Then
                strsearch = Trim(txtbookingno.Text & "")
            ElseIf ddlSearchOn.SelectedItem.Text = "Container No" Then
                strsearch = Trim(txtbookingno.Text & "")
            ElseIf ddlSearchOn.SelectedItem.Text = "Transporter" Then
                strsearch = Trim(ddltransporter.SelectedItem.Text & "")
            End If
            strSql = ""
            strSql += " Sp_EyardContainerBookingReport '" & Convert.ToDateTime(Trim(txtfromDate.Text & "")).ToString("yyyy-MM-dd HH:mm") & "','" & Convert.ToDateTime(Trim(txttoDate.Text & "")).ToString("yyyy-MM-dd HH:mm") & "','" & Trim(ddlSearchOn.SelectedItem.Text) & "',"
            strSql += "'" & strsearch & "'"
    ...
    Protected Sub ddlSearchOn_SelectedIndexChanged(sender As Object, e As EventArgs)
        ...
        End If
        If (ddlSearchOn.SelectedValue = "5") Then
