<%@ Page Title="Depo | Cancel Estimation" Language="VB" EnableEventValidation="false" MasterPageFile="~/Depo/PopUp.master" AutoEventWireup="false" CodeFile="CancelEstimation.aspx.vb" Inherits="Account_ItemList" Culture="en-GB" %>
...
<h1>Cancel Estimation<small class="pull-left" style="margin-right:20px"></small></h1>
...
<div class="form-group text-label">
<b  >Estimate Date</b>
<asp:TextBox ID="txtEstdate" Style="text-transform:uppercase" ReadOnly="true" class="form-control text-label"  placeholder="Estimate Date"
runat="server"   ></asp:TextBox>
</div>
</div>
...
<div class="form-group text-label">
<b  >Estimate Amt</b>
<asp:TextBox ID="txtAmt" Style="text-transform:uppercase" ReadOnly="true" class="form-control text-label"  placeholder="Estimate Amt"
runat="server"   ></asp:TextBox>
</div>
</div>
