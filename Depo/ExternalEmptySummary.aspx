<%@ Page Title="Depo | External Empty Summary" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="ExternalEmptySummary.aspx.vb" Inherits="Summary_BCYMovement" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <head>
<title>Depo |External Empty Summary</title>
</head>
    <style>
        .header-center{
            text-align:center
...
<h3>
<i class="glyphicon glyphicon-transfer"></i>External Empty Summary
</h3>
