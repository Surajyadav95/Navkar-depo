<%@ Page Title="Proforma Invoice" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="ProformaInvoice.aspx.vb" Inherits="Summary_BCYMovement" Culture="en-GB" %>
...
<h3>
<i class="glyphicon glyphicon-transfer"></i>Proforma Invoice
</h3>           
</div>
...
<asp:TextBox ID="txtRemarks" TextMode="MultiLine" Rows="2"  placeholder="Remarks" runat="server" Class="form-control text-label"></asp:TextBox>
    ...
    <div class="row">
        <div class="col-lg-6">
                            ...
                            <b><asp:linkButton ID="lnkdetails" runat="server" Text="Click here to view Proforma details" ForeColor="Blue" Font-Size="15px"
        ...
        <div class="col-lg-6">
<div class="form-group" style="margin-top:8px">
<b><asp:linkButton ID="LinkButton2" runat="server" Text="Click here to add Additional charges" ForeColor="Blue" Font-Size="15px"
OnClientClick="return OpenAdditional();"></asp:linkButton></b>
</div>
</div>
    </div>
     </asp:Panel>                      
...
<a href="ProformaInvoice.aspx" class="btn btn-danger ">No</a>
</div>
</div>
</ContentTemplate>
</asp:UpdatePanel>
...
<asp:Label ID="lblSize" Visible="true" runat="server" text='<%#Eval("Size")%>'></asp:Label>
...
<a href="ProformaInvoice.aspx" class="btn btn-primary btn-sm outline pull-left"
...
<br /><br /><br />
    ...
    <script type="text/javascript">
        ...
        function OpenInvoicelist() {
            ...
            var url = "ListofProformaDetails.aspx"
...
window.open(url);
   ...
   <script type="text/javascript">
       ...
       function OpenInvoicePrint() {
           ...
           var url = "../Depo/Report_Epic/HandlingStorageProformaPrint.aspx?InvoiceNo=" + txtAssessNoPrint + "&WorkYear=" + txtWorkYearPrint + "&LineID=" + txtLineIDPrint + "&InvoiceType=" + txtInvoiceTypePrint
...
<script type="text/javascript">
    ...
    function OpenAdditional() {
        var url = "AdditionalCharges.aspx"
