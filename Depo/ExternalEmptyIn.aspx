...
CodeFile="ExternalEmptyIn.aspx.vb" Inherits="Summary_BCYMovement" Culture="en-GB" %>
...
<div class="panel-body">
     <div class="row">
        ...
        <asp:DropDownList  ID="ddlExternalLocation"  Style="text-transform: uppercase;" runat="server" class="form-control text-label">    
               <asp:ListItem Value="0">--Select--</asp:ListItem> 
        <asp:ListItem Value="1">CFS MTY</asp:ListItem>
        ...
        <div class="form-group text-label">
        <b>Train No</b>
        <asp:TextBox  ID="txtTrainNo"  ReadOnly="true"  placeholder="Train No" Style="text-transform: uppercase;" runat="server" class="form-control text-label">                                    
        </asp:TextBox>
        </div>
        </div>
            <div class="col-sm-1 col-xs-6">                                    
        <div class="form-group pull-left" style="padding-top:20px; height: 40px; ">
        <asp:LinkButton ID="lnkTrainSearch" ControlStyle-CssClass='btn btn-primary'  runat="server"
        OnClientClick="return TrainSearch();">  
    ...
    <div class="row">
        ...
        <asp:TextBox  ID="txtShippConsignee"   placeholder="Shipper/Consignee" Style="text-transform: uppercase;" runat="server" class="form-control text-label">                                    
        </asp:TextBox>
        </div>
        </div>
...
<ContentTemplate>
     <Triggers>
        ...
        AutoGenerateColumns="False" EmptyDataText="No records found!"  OnRowDataBound="grdcontainer_RowDataBound" ShowHeaderWhenEmpty="true" >
...
<asp:CheckBox ID="chkright" Text="" Checked='<%#Eval("Check")%>' onclick = "Check_Click(this)" runat="server" />
  ...
  <ItemStyle Width="20px" HorizontalAlign="Center" />                                    
       ...
       <%--<asp:Label ID="lblShippingLine" runat="server" text='<%#Eval("SLName")%>'></asp:Label>--%>
        ...
        <asp:Label ID="lblunitfor" runat="server" Text='<%# Eval("LineID")%>' Visible = "false" />
                                           <asp:DropDownList ID="ddlLineID" runat="server" class="form-control " width="150px" >
       ...
       <%--<asp:Label ID="lblDoValidDate" runat="server" text='<%#Eval("ValidDate")%>'></asp:Label>--%>
             <asp:textbox ID="txtDoValidDates" class="form-control"   Width="150px" placeholder="yyyy-mm-dd " TextMode="Date" runat="server"  text='<%#Eval("ValidDate")%>'></asp:textbox>
            <%--<asp:TextBox ID="txtDovaliddates"   placeholder="yyyy-mm-dd " TextMode="Date"  runat="server"   Class="form-control text-label"></asp:TextBox>--%>
        </ItemTemplate>
        <ItemStyle Width="20px" HorizontalAlign="Center" /> 
        </asp:TemplateField>
    ...
    <asp:Button ID="btnTrainSearch" runat="server" Text="Call Button Click" style="display:none"  OnClick="btnTrainSearch_Click" />
    <div class="row">
...
<a href="ExternalEmptySummary.aspx" target="_blank"><b style="color:blue">Click here to views list of External Container Details</b> </a>
</div>
</div>
...
<a href="ExternalEmptyIn.aspx" class="btn btn-info btn-block">OK</a>
...
<a href="ExternalEmptyIn.aspx" class="btn btn-danger ">No</a>
</div>
</div>
</ContentTemplate>
</asp:UpdatePanel>
