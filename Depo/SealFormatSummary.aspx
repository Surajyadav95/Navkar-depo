<%@ Page Title="Depo | Seal Format" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="SealFormatSummary.aspx.vb" Inherits="Summary_BCYMovement" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <head>
<title>Depo | Seal Format</title>
</head>
    <style>
        .header-center{
            text-align:center
...
<h3>
<i class="glyphicon glyphicon-transfer"></i>Seal Format
</h3>
...
<asp:DropDownList ID="ddljoype" Style="text-transform: uppercase;border-radius:4px" runat="server" class="form-control"></asp:DropDownList>
   ...
   <div class="row">
        <div class="col-md-2 col-xs-12 pull-right">
                                <div class="form-group pull-right" style="margin-top:-46px;">
