<%@ Page Title="Depo | Change Size Type" Language="VB" EnableEventValidation="false" MasterPageFile="~/Depo/PopUp.master" AutoEventWireup="false" CodeFile="ChangeSizeType.aspx.vb" Inherits="Account_ItemList" Culture="en-GB" %>
...
<h1>Change Size Type<small class="pull-left" style="margin-right:20px"></small></h1>
...
<a href="ChangeSizeType.aspx" class="btn btn-info btn-block">OK</a>
...
<a href="ChangeSizeType.aspx" class="btn btn-danger ">No</a>
</div>
</div>
