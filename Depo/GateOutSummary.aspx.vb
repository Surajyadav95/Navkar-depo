...
Partial Class Summary_BCYMovement
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        Try
            ...
            End If
            strSql = ""
            strSql += " Get_Sp_EyardOutDetails '" & Convert.ToDateTime(Trim(txtfromDate.Text & "")).ToString("yyyy-MM-dd HH:mm") & "','" & Convert.ToDateTime(Trim(txttoDate.Text & "")).ToString("yyyy-MM-dd HH:mm") & "',"
            strSql += "'" & Trim(ddlcriteria.SelectedItem.Text & "") & "','" & Name & "'"
            dt = db.sub_GetDatatable(strSql)
            grdGateOutSummary.DataSource = dt
            grdGateOutSummary.DataBind()
            ...
            If (dt.Rows.Count > 0) Then
                Using wb As New XLWorkbook()
                    ...
                    With wb.Worksheets(0)
                        ...
                        .Cell(8, 1).Value = "Gate Out Details"
    ...
    Protected Sub ddlcriteria_SelectedIndexChanged(sender As Object, e As EventArgs)
        ...
        End Try
    End Sub
    Protected Sub grdGateOutSummary_PageIndexChanging(sender As Object, e As GridViewPageEventArgs)
        Try
            grdGateOutSummary.PageIndex = e.NewPageIndex
