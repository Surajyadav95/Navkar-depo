...
Partial Class Summary_BCYMovement
    ...
    Protected Sub btnShow_Click(sender As Object, e As EventArgs)
        Try
            ...
            strSql = ""
            strSql += " GetEstimationDetails '" & Convert.ToDateTime(Trim(txtfromDate.Text & "")).ToString("yyyy-MM-dd HH:mm") & "','" & Convert.ToDateTime(Trim(txttoDate.Text & "")).ToString("yyyy-MM-dd HH:mm") & "','" & Trim(ddlSearchOn.SelectedItem.Text) & "',"
            ...
            If (dt10.Rows.Count > 0) Then
                Using wb As New XLWorkbook()
                    ...
                    With wb.Worksheets(0)
                        ...
                        Excelno = db.GetExcelColumnName(6)
        ...
        Try
            ...
            If (dt10.Rows.Count > 0) Then
                Using wb As New XLWorkbook()
                    ...
                    With wb.Worksheets(0)
                        Dim Excelno As String = ""
                        Excelno = db.GetExcelColumnName(7)
                        .Range("A1:" & Excelno & "1").InsertRowsAbove(9)
                        .Range("A1:" & Excelno & "1").Merge()
                        .Range("A2:" & Excelno & "2").Merge()
                        .Range("A3:" & Excelno & "3").Merge()
                        ...
                        For Each row In grdRegistrationSummary.Rows
                            If CType(row.FindControl("chkright"), CheckBox).Checked = True Then
                                ...
                                .Column(7).Width = 15
                                .Cell(introw, 2).Value = Trim(CType(row.FindControl("lblShippingLine"), Label).Text)
                                .Cell(introw, 6).Value = "Location:"
                                .Cell(introw, 7).Value = "ICD-TUI"
                                .Row(introw).InsertRowsBelow(1)
                                introw += 1                                
                                ...
                                .Cell(introw, 2).Value = "Size & Type "
                                .Cell(introw, 2).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Center
                                .Cell(introw, 2).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center

                                .Cell(introw, 3).Value = "CSC Details"
                                .Cell(introw, 3).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Center
                                .Cell(introw, 3).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center

                                .Cell(introw, 4).Value = "Ref No"
                                .Cell(introw, 4).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Center
                                .Cell(introw, 4).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center

                                .Cell(introw, 5).Value = "In Date"
                                .Cell(introw, 5).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Center
                                .Cell(introw, 5).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center

                                .Cell(introw, 6).Value = "Gross Wt"
                                .Cell(introw, 6).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Center
                                .Cell(introw, 6).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center

                                .Cell(introw, 7).Value = "Tare Wt"
                                .Cell(introw, 7).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Center
                                .Cell(introw, 7).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center
                                ...
                                .Cell(introw, 2).Value = Trim(CType(row.FindControl("lblSize"), Label).Text) + Trim(CType(row.FindControl("lblContainerType"), Label).Text)
                                .Cell(introw, 2).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Center
                                .Cell(introw, 2).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center
                                .Cell(introw, 2).DataType = XLCellValues.Text

                                .Cell(introw, 3).Value = Trim(CType(row.FindControl("lblCSCASP"), Label).Text)
                                .Cell(introw, 3).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Center
                                .Cell(introw, 3).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center

                                .Cell(introw, 4).Value = Trim(CType(row.FindControl("lblManualEstimateNo"), Label).Text)
                                .Cell(introw, 4).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Center
                                .Cell(introw, 4).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center

                                .Cell(introw, 5).Value = Trim(CType(row.FindControl("lblInDate"), Label).Text)
                                .Cell(introw, 5).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Center
                                .Cell(introw, 5).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center

                                .Cell(introw, 6).Value = Trim(CType(row.FindControl("lblGrossWeight"), Label).Text)
                                .Cell(introw, 6).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Center
                                .Cell(introw, 6).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center

                                .Cell(introw, 7).Value = Trim(CType(row.FindControl("lblTareWeight"), Label).Text)
                                .Cell(introw, 7).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Center
                                .Cell(introw, 7).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center
                                ...
                                For i As Integer = 0 To dt1.Rows.Count - 1
                                    dblManHrs += Format(dt1.Rows(i)("Man Hour"), "0.00")
                                    dblhrsCost += Format(dt1.Rows(i)("Labour Cost"), "0.00")
                                    dblMtlCost += Format(dt1.Rows(i)("Material Cost"), "0.00")
                                    dblTotalCost += Format(dt1.Rows(i)("Total Cost"), "0.00")
                                Next
                                introw += dt1.Rows.Count + 1
                                
                                .Cell(introw, 2).Value = "Total"
                                For i = 1 To 7
                                    .Cell(introw, i).Style.Fill.BackgroundColor = XLColor.Yellow
                                Next
                    ...
                    With wb.Worksheets(0)
                        ...
                        For Each row In grdRegistrationSummary.Rows
                            ...
                            If CType(row.FindControl("chkright"), CheckBox).Checked = True Then
                                ...
                                .Cell(introw, 4).Value = Val(dt2.Rows(0)("Damage") & "") + Val(dt2.Rows(0)("Washing") & "")
                                .Cell(introw, 4).Style.Fill.BackgroundColor = XLColor.Tan
        ...
        Try
            ...
            If (dt10.Rows.Count > 0) Then
                Using wb As New XLWorkbook()
                    ...
                    With wb.Worksheets(0)
                        Dim Excelno As String = ""
                        Excelno = db.GetExcelColumnName(10)
                        .Range("A1:" & Excelno & "1").InsertRowsAbove(9)
                        .Range("A1:" & Excelno & "1").Merge()
                        .Range("A2:" & Excelno & "2").Merge()
                        .Range("A3:" & Excelno & "3").Merge()
                        ...
                        For Each row In grdRegistrationSummary.Rows
                            ...
                            If CType(row.FindControl("chkright"), CheckBox).Checked = True Then
                                ...
                                .Column(10).Width = 15
                                .Column(11).Width = 15
                                .Cell(introw, 2).Value = Trim(CType(row.FindControl("lblSAID"), Label).Text)
                                .Cell(introw, 2).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Left
                                .Cell(introw, 2).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center
                                .Cell(introw, 2).Style.Fill.BackgroundColor = XLColor.LightPink

                                .Cell(introw, 3).Value = "Labour Cost"
                                .Cell(introw, 3).Style.Fill.BackgroundColor = XLColor.LightGray
                                .Cell(introw, 3).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Left
                                .Cell(introw, 3).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center
                                .Cell(introw, 4).Value = Trim(CType(row.FindControl("lblManCost"), Label).Text)
                                .Cell(introw, 4).Style.Fill.BackgroundColor = XLColor.LightPink
                                .Cell(introw, 4).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Left
                                .Cell(introw, 4).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center
                                introw += 1
                                .Cell(introw, 1).Value = "Estimate of Repairs"
                                .Cell(introw, 1).Style.Fill.BackgroundColor = XLColor.LightGray
                                .Cell(introw, 1).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Left
                                .Cell(introw, 1).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center
                                .Cell(introw, 2).Style.Fill.BackgroundColor = XLColor.LightPink
                                ...
                                .Cell(introw, 3).Value = "SIZE & TYPE:"
                                .Cell(introw, 3).Style.Fill.BackgroundColor = XLColor.LightGray
                                .Cell(introw, 3).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Left
                                .Cell(introw, 3).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center
                                .Cell(introw, 4).Value = Trim(CType(row.FindControl("lblSize"), Label).Text) + Trim(CType(row.FindControl("lblContainerType"), Label).Text)
                                .Cell(introw, 4).Style.Fill.BackgroundColor = XLColor.LightPink
                                .Cell(introw, 4).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Left
                                .Cell(introw, 4).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center
                                introw += 1                                
                                .Cell(introw, 1).Value = "CSC/ASP:"
                                .Cell(introw, 1).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Left
                                .Cell(introw, 1).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center
                                .Cell(introw, 1).Style.Fill.BackgroundColor = XLColor.LightGray
                                .Cell(introw, 2).Value = Trim(CType(row.FindControl("lblCSCASP"), Label).Text)
                                ...
                                .Cell(introw, 4).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center
                                introw += 1
                                .Cell(introw, 1).Value = "MGW:"
                                .Cell(introw, 1).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Left
                                .Cell(introw, 1).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center
                                .Cell(introw, 1).Style.Fill.BackgroundColor = XLColor.LightGray
                                .Cell(introw, 2).Value = Trim(CType(row.FindControl("lblGrossWeight"), Label).Text)
                                .Cell(introw, 2).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Left
                                .Cell(introw, 2).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center
                                .Cell(introw, 2).Style.Fill.BackgroundColor = XLColor.LightPink
                                .Cell(introw, 3).Value = "In Date:"
                                ...
                                .Cell(introw, 3).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center
                                .Cell(introw, 3).Style.Fill.BackgroundColor = XLColor.LightGray
                                .Cell(introw, 4).Value = Trim(CType(row.FindControl("lblInDate"), Label).Text)
                                .Cell(introw, 4).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Left
                                .Cell(introw, 4).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center
                                .Cell(introw, 4).Style.Fill.BackgroundColor = XLColor.LightPink

                                introw += 1
                                .Cell(introw, 1).Value = "TARE WT:"
                                .Cell(introw, 1).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Left
                                .Cell(introw, 1).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center
                                .Cell(introw, 1).Style.Fill.BackgroundColor = XLColor.LightGray
                                .Cell(introw, 2).Value = Trim(CType(row.FindControl("lblTareWeight"), Label).Text)
                                .Cell(introw, 2).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Left
                                .Cell(introw, 2).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center
                                .Cell(introw, 2).Style.Fill.BackgroundColor = XLColor.LightPink
                                ...
                                If Trim(CType(row.FindControl("lblMFGDate"), Label).Text) = "" Then
                                    MFGDate = ""
                                Else
                                    MFGDate = Convert.ToDateTime(Trim(CType(row.FindControl("lblMFGDate"), Label).Text)).ToString("MMM-yyyy")
                                End If
                                .Cell(introw, 2).Value = MFGDate
                                .Cell(introw, 2).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Left
                                .Cell(introw, 2).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center
                                .Cell(introw, 2).Style.Fill.BackgroundColor = XLColor.LightPink
                                introw += 1
                                ...
                                For i = 1 To 10
                                    .Cell(introw, i).Style.Fill.BackgroundColor = XLColor.Yellow
                                Next
                                .Cell(introw, 1).Value = "Grand Total"
                                '.Cell(introw, 1).Style.Fill.BackgroundColor = XLColor.Yellow
                                .Cell(introw, 1).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Left
                                .Cell(introw, 1).Style.Alignment.Vertical = XLAlignmentVerticalValues.Center
                                .Cell(introw, 7).Value = dblManHrs
                                '.Cell(introw, 7).Style.Fill.BackgroundColor = XLColor.Yellow
                                .Cell(introw, 8).Value = dblhrsCost
                                '.Cell(introw, 8).Style.Fill.BackgroundColor = XLColor.Yellow
                                .Cell(introw, 9).Value = dblMtlCost
                                '.Cell(introw, 9).Style.Fill.BackgroundColor = XLColor.Yellow
                                .Cell(introw, 10).Value = dblTotalCost
                                '.Cell(introw, 10).Style.Fill.BackgroundColor = XLColor.Yellow
                            End If
                        Next
                    End With
