<%@ Page Title="Depo |Account Summary" Language="VB" MasterPageFile="../Depo/User.master" AutoEventWireup="false"
CodeFile="AccountSummary.aspx.vb" Inherits="Summary_BCYMovement" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
<head>
<title>Depo |  Account Summary .</title>
</head>
<div class="page-container">
<div class="pageheader">
<h3>
<i class="glyphicon glyphicon-transfer"></i>Account Summary  
</h3>
...
<asp:BoundField DataField="AccountName" HeaderText="AccountName"></asp:BoundField>
...
<asp:BoundField DataField="HSNCode" HeaderText="HSN Code"  ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center"></asp:BoundField>
