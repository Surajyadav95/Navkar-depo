...
Partial Class Summary_BCYMovement
    ...
    Private Sub fill_Container_Summary()
        ...
        strSql = ""
        strSql += " Get_Sp_ExternalInventory_NEW '" & Convert.ToDateTime(Trim(txtason.Text & "")).ToString("yyyyMMddHHmm") & "','" & Trim(ddlcriteria.SelectedItem.Text & "") & "',"
    ...
    Protected Sub btnExport_Click(sender As Object, e As EventArgs) Handles btnExport.Click
        Try
            ...
            strSql = ""
            strSql += " Get_Sp_ExternalInventory_NEW '" & Convert.ToDateTime(Trim(txtason.Text & "")).ToString("yyyyMMddHHmmss") & "','" & Trim(ddlcriteria.SelectedItem.Text & "") & "',"
