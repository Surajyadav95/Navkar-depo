...
Partial Class Summary_BCYMovement
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        Try
            ...
            End If
            strSql = ""
            strSql += " Get_Sp_EyardInDetails '" & Convert.ToDateTime(Trim(txtfromDate.Text & "")).ToString("yyyy-MMM-dd HH:mm") & "','" & Convert.ToDateTime(Trim(txttoDate.Text & "")).ToString("yyyy-MMM-dd HH:mm") & "',"
    ...
    Protected Sub btnExport_Click(sender As Object, e As EventArgs) Handles btnExport.Click
        Try
            ...
            strSql = ""
            strSql += " Get_Sp_EyardInDetails '" & Convert.ToDateTime(Trim(txtfromDate.Text & "")).ToString("yyyy-MM-dd HH:mm") & "','" & Convert.ToDateTime(Trim(txttoDate.Text & "")).ToString("yyyy-MM-dd HH:mm") & "',"
            strSql += "'" & Trim(ddlcriteria.SelectedItem.Text & "") & "','" & Name & "'"
            dt = db.sub_GetDatatable(strSql)
            strSql = ""
