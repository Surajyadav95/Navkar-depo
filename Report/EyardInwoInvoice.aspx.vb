...
Partial Class Report_Estimation_Default
    ...
    Private Sub LoadReport()
        Try
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Depo/Report_Epic/EyardInwoInvoice.rdlc")
            ...
            Dim ValidDate As String = Trim(ds.Tables(0).Rows(0)("ValidDate") & "")
            ...
            Dim p9 As New ReportParameter("ValidDate", ValidDate)
            Dim p10 As New ReportParameter("location", location)
            ...
            Me.ReportViewer1.LocalReport.SetParameters(New ReportParameter() {p1, p2, p3, p5, p7, p9, p10, p11, p12, p13, p14, p15, p16})
